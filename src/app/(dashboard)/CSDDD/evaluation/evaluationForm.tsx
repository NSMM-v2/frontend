            ...
            <div className="px-6 py-5 border-b border-gray-100">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  disabled={loading}
                  className="inline-flex items-center px-3 py-1.5 text-sm text-white transition-all bg-blue-600 rounded-md hover:bg-blue-700 hover:shadow disabled:opacity-50 disabled:cursor-not-allowed">
                  <RefreshCw
                        ...
                        {isExpanded && selectedResult?.answers && (
                          <div className="pt-4 mt-4 border-t border-gray-200">
                            ...
                            <div className="space-y-4">
                              {selectedResult.answers.filter(a => a.answer === false)
                                .length === 0 ? (
                                <div className="p-6 border border-blue-200 shadow-sm rounded-xl bg-gradient-to-br from-blue-50 to-white">
