...
import Scope1Calculator from "@/components/tools/scopeInput"
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full gap-4 p-4">
      {calculators.map((calc) => (
        <Scope1Calculator key={calc.id} id={calc.id} onChangeTotal={updateTotal} />
      ))}

      <Button onClick={addCalculator}>연료 추가</Button>
